...
function readData() {
	...
	function mode_reading() {
		...
		function pageMode() {
			...
			if (editMode === 'on') {
				document.getElementById('contentsControl').style.backgroundColor = '#9CC0E7';
				document.getElementById('pageMode').innerHTML = '[편집모드]';
			} else {
				document.getElementById('contentsControl').style.backgroundColor = '#EEEEEE';
				document.getElementById('pageMode').innerHTML = '[읽기모드]';
			}
		}
		pageMode();
	}
