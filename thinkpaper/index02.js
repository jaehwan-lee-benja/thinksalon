...
function requestPushPackagedData_direction(packagedBpDataHere) {
	db.ref("users")
	.child(userData.uid)
	.child("bpData")
	.child("character")
...
function printSpoonedBpData() {
	...
	btnShowHideHandler("readPaper","_C");
}; // 점검중
...
function printEmptySpoonedBpData() {
	...
	btnShowHideHandler("createFirstPaper","_C");
}; // 점검중
...
function btnShowHideHandler(state, section) {

	// console.log("check = ", "openEditPaper_btn"+section);
	// console.log("check2 = ", selectorById("openEditPaper_btn"));
	// console.log("check3 = ", selectorById("openEditPaper_btn"+section));

	uiHide("openEditPaper_btn"+section);
	uiHide("cancelEditPaper_btn"+section);
	uiHide("saveEditedPaper_btn"+section);
	uiHide("saveNewPaper_btn"+section);
	uiHide("removePaper_btn"+section);
	uiHide("openNewPaper_btn"+section);

	switch(state){
		case "createFirstPaper" :
			uiShow("saveNewPaper_btn"+section);
			editModeHandler_character("divCharacter", "editing");
			break;
		case "openNewPaper" :
			uiShow("saveNewPaper_btn"+section);
			uiShow("cancelEditPaper_btn"+section)
			editModeHandler_character("divCharacter", "editing");
			break;
		case "readPaper" :
			uiHide("guideMessage");
			uiShow("openEditPaper_btn"+section);
			uiShow("openNewPaper_btn"+section);
			uiShow("removePaper_btn"+section);
			editModeHandler_character("divCharacter", "reading");
			break;
		case "editPaper" :
			uiShow("saveEditedPaper_btn"+section);
			uiShow("cancelEditPaper_btn"+section);
			uiShow("saveNewPaper_btn"+section);
			uiShow("removePaper_btn"+section);
			editModeHandler_character("divCharacter", "editing");
...
function editModeHandler_character(className, paperMode) {
...
function openNewPaper() {
	printEmptySpoonedBpData();
	btnShowHideHandler("openNewPaper","_C");
}; // 점검중
...
function openEditPaper() {
	btnShowHideHandler("editPaper","_C");
}; // 점검중
